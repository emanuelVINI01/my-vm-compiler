...
This project is part of the broader CVM ecosystem:
- **[my-vm](../my-vm)**: The custom Virtual Machine that executes the `.asm` files generated by this compiler.
- **[my-vm-os](../my-vm-os)**: A custom operating system written in CVM, acting as the primary use-case and testbed for this compiler.
